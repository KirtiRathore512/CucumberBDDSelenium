...
public class ProductDescPageObject {
 ...
 private static final Logger logger = LogManager.getLogger(ProductDescPageObject.class);
	...
	//Section 3 : Define the locators
	 ...
	 private By listOfProduct = By.xpath("//span[text()=\"RESULTS\"]//ancestor::div[@class='s-main-slot s-result-list s-search-results sg-row']//span[@class='a-size-medium a-color-base a-text-normal']");
	...
	// Section 4 : Write Business Methods (methods to be exposed) agent
	 ...
	 public void clickOnAnyProduct()
	 {
		...
		List<WebElement> firstProd= driver.findElements(listOfProduct);
